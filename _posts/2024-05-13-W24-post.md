...
Through discussion with my team leaders, I've changed my opinion on my objective for this goal. Originally, I intended to estimate in great detail the time required for small pieces of a project. Through helpful guidance and experience, I've learned it's an unrealistic approach. There are too many variables. It is impossible to anticipate everything that will occur during the course of a ticket. The time you would have to spend to accurately estimate tickets is better spent just working on them. I have learned to focus on adaptability and flexibility instead.
